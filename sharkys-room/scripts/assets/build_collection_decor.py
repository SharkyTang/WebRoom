...
from v06c_mesh_cleanup import clean_exported_glb
...
def build(family,preview=False):
 ...
 bpy.context.scene['export_cleanup']='Preserve editable source topology; exported GLB removes strictly zero-area triangles and unused vertices, preserving every retained attribute byte. See scripts/assets/v06c_mesh_cleanup.py.'
 ...
 result['sourceTriangles']=result['triangles']
 result['exportCleanup']=clean_exported_glb(glb)
 result['triangles']=result['exportCleanup']['exportedTriangles']
