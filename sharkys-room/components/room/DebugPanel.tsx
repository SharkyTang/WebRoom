...
export function DebugPanel({ validation, performance, interaction }: { validation: RoomValidation | null; performance: RoomPerformance | null; interaction: InteractionState }) {
