...
Mode: development
Generated: 2026-09-18T06:51:16.083Z
...
| floor: isolated GLB404 keeps the full proxy family and all other 26 formal families | PASS |
| walls: isolated GLB404 keeps the full proxy family and all other 26 formal families | PASS |
| door: isolated GLB404 keeps the full proxy family and all other 26 formal families | PASS |
| window: isolated GLB404 keeps the full proxy family and all other 26 formal families | PASS |
| curtains: isolated GLB404 keeps the full proxy family and all other 26 formal families | PASS |
| desk: isolated GLB404 keeps the full proxy family and all other 26 formal families | PASS |
| cabinet: isolated GLB404 keeps the full proxy family and all other 26 formal families | PASS |
| bed: isolated GLB404 keeps the full proxy family and all other 26 formal families | PASS |
| bedside: isolated GLB404 keeps the full proxy family and all other 26 formal families | PASS |
| sofa: isolated GLB404 keeps the full proxy family and all other 26 formal families | PASS |
| chair: isolated GLB404 keeps the full proxy family and all other 26 formal families | PASS |
| coffee: isolated GLB404 keeps the full proxy family and all other 26 formal families | PASS |
| sidetable: isolated GLB404 keeps the full proxy family and all other 26 formal families | PASS |
| beanbag: isolated GLB404 keeps the full proxy family and all other 26 formal families | PASS |
| rugs: isolated GLB404 keeps the full proxy family and all other 26 formal families | PASS |
| dogbed: isolated GLB404 keeps the full proxy family and all other 26 formal families | PASS |
