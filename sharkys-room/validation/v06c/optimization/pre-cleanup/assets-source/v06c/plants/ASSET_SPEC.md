...
- 实际 GLB：**454,248 B**；可编辑 .blend：**167,118 B**。
- 7,944 三角面、15 网格、15 primitives、3 材质、0 嵌入图片。primitives 不等于实际渲染 draw calls。
- 本家族无相机、灯光源或动画；无外部纹理/缓冲 URI。GLB 文件字节不等于 HTTP 传输量、显存或帧时间。
- GLB SHA-256：`41f517b3c98e013c58afcb11552e42c86be967d392b20c17cc1ef3e024a9b4d4`。
