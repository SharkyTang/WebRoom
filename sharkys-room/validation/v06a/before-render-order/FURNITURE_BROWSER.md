...
Mode: development
Generated: 2026-09-17T17:27:54.446Z
...
| floor: isolated GLB404 keeps the full proxy family and all other eighteen formal families | PASS |
| walls: isolated GLB404 keeps the full proxy family and all other eighteen formal families | PASS |
| door: isolated GLB404 keeps the full proxy family and all other eighteen formal families | PASS |
| window: isolated GLB404 keeps the full proxy family and all other eighteen formal families | PASS |
| curtains: isolated GLB404 keeps the full proxy family and all other eighteen formal families | PASS |
| desk: isolated GLB404 keeps the full proxy family and all other eighteen formal families | PASS |
| cabinet: isolated GLB404 keeps the full proxy family and all other eighteen formal families | PASS |
| bed: isolated GLB404 keeps the full proxy family and all other eighteen formal families | PASS |
| bedside: isolated GLB404 keeps the full proxy family and all other eighteen formal families | PASS |
| sofa: isolated GLB404 keeps the full proxy family and all other eighteen formal families | PASS |
| chair: isolated GLB404 keeps the full proxy family and all other eighteen formal families | PASS |
| coffee: isolated GLB404 keeps the full proxy family and all other eighteen formal families | PASS |
| sidetable: isolated GLB404 keeps the full proxy family and all other eighteen formal families | PASS |
| beanbag: isolated GLB404 keeps the full proxy family and all other eighteen formal families | PASS |
| rugs: isolated GLB404 keeps the full proxy family and all other eighteen formal families | PASS |
| dogbed: isolated GLB404 keeps the full proxy family and all other eighteen formal families | PASS |
| floor: corrupted embedded image prevents every partial visual from being installed | PASS |
| bed: corrupted embedded image prevents every partial visual from being installed | PASS |
| Delayed desk load can be abandoned; repeated reloads preserve one complete assembly and stable resource counts | PASS |
